 ...
 */
@Stateless
@Path("com.iesvdc.acceso.entidades.prestamos")
public class PrestamosFacadeREST extends AbstractFacade<Prestamos> {
    ...
    public PrestamosFacadeREST() {
        ...
        this.em = Persistence.createEntityManagerFactory("ProyectoFinalPU").createEntityManager();
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Prestamos entity) {
        super.edit(entity);
    }
    ...
    public Prestamos find(@PathParam("id") Integer id) {
